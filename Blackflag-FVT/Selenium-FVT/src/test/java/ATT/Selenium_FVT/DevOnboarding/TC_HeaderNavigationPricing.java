...
public class TC_HeaderNavigationPricing extends TestUtil{


	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickPricing();	
		headers.validatePricingPage();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HeaderNavigationPricing.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
