...
/* Test case to Verify that the Dev portal Page routes to correct link when clicked on Privacy Policy*/	

public class TC_FooterNavigationPrivacyPolicy extends TestUtil{

	@Test
	public void testPolicyNavigation() {
		...
		headers.clickLogo();
		footer.clickPrivacynPolicy();
		footer.validatePrivacyPolicy();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationPrivacyPolicy.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
