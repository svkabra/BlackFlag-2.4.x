...
public class TC_FooterNavigationSupportOverview extends TestUtil{
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickSupportOverview();	
		footer.validateSupportOverview();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationSupportOverview.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
