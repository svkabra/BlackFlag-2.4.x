...
public class TC_FooterNavigationSdkPlugins extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Sdks, Plugins and more*/	
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickSdkPlugin();		
		footer.validateSdkPlugin();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationSdkPlugins.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
