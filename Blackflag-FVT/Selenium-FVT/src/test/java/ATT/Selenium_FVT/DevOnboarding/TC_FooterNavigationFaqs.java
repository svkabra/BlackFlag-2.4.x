...
public class TC_FooterNavigationFaqs extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on FAQs*/	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationFaqs.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
