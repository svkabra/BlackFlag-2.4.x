...
public class TC_FooterNavigationOurAPIs extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Our APIs */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationOurAPIs.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
