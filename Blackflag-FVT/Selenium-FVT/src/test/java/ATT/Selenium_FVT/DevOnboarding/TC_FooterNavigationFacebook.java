...
public class TC_FooterNavigationFacebook extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Social Networking sites link*/	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationFacebook.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
