...
public class TC_HomeLogoDisplayed extends TestUtil{

	/* Test case to verify that home logo is displayed*/	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HomeLogoDisplayed.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
