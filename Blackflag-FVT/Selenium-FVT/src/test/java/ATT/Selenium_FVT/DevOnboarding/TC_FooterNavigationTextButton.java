...
public class TC_FooterNavigationTextButton extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on AT&T Text Button*/	
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickTextButton();	
		footer.validateTextButton();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationTextButton.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
