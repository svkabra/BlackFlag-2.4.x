...
public class TC_HeaderNavigationStories extends TestUtil {

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Stories*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickStories();
		headers.validateSuccessStroiesPage();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HeaderNavigationStories.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
