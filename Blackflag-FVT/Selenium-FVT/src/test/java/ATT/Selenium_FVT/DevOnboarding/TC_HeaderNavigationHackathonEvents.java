...
public class TC_HeaderNavigationHackathonEvents extends TestUtil{
	...
	public void testHeaderNavigation() {
		...
		headers.clickHackathonsEvents();
		headers.validateHackathonsEventsPage();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HeaderNavigationHackathonEvents.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
