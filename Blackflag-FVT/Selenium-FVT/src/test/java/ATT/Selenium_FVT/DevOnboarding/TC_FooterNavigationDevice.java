...
public class TC_FooterNavigationDevice extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Device*/	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationDevice.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
