...
public class TC_JoinNowEmailValidation extends TestUtil{
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_JoinNowEmailValidation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
