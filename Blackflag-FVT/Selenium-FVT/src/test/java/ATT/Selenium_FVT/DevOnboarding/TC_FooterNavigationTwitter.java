...
public class TC_FooterNavigationTwitter extends TestUtil{
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationTwitter.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
