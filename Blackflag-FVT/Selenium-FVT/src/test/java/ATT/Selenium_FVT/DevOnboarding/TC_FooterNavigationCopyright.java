...
public class TC_FooterNavigationCopyright extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on AT&T Application Resource Optimizer*/	
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickCopyRight();		
		footer.validateCopyRight();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationAttAro.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
