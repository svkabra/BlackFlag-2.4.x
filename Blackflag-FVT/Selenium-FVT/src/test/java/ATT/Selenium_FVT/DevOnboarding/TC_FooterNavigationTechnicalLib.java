...
public class TC_FooterNavigationTechnicalLib extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on Technical Library*/	
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickTechnicalLib();		
		footer.validateTechnicalLib();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationTechnicalLib.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
