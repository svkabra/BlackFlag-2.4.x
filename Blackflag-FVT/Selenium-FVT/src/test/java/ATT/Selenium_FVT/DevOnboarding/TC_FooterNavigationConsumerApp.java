...
public class TC_FooterNavigationConsumerApp extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on AT&T AppCenter for Consumer Apps*/	
	...
	public void testFooterNavigation() {
		...
		headers.clickLogo();
		footer.clickConsumerApp();		
		footer.validateConsumerApp();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationConsumerApp.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
