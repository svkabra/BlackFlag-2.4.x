...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on Terms of Use*/	
public class TC_FooterNavigationTermsofUse extends TestUtil{

	@Test
	public void testTnCNavigation() {
		...
		headers.clickLogo();
		footer.clickTermsnCondition();	
		footer.validateTermsConditions();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationTermsofUse.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
