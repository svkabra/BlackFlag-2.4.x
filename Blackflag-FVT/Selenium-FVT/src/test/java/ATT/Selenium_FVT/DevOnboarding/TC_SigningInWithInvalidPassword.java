...
public class TC_SigningInWithInvalidPassword extends TestUtil{

	/* Test case to verify that Error message is displayed when user signs in with invalid password */	
	...
	public void testFooterNavigation() {
		...
		apilogpage.openURL();			 
		apilogpage.testLogIn(Constants.DEV_USERNAME,"password");
