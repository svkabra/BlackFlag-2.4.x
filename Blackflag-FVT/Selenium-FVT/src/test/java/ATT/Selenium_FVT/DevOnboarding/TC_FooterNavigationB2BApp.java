...
public class TC_FooterNavigationB2BApp extends TestUtil{

	/* Test case to verify that the Dev portal Page routes to correct link when clicked on B2BApp*/	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationB2BApp.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
