...
public class TC_AccountSettingsVerifyNewPasswordFieldValidationDev extends
		TestUtil {

	@Test
	public void accountSettingsVerifyNewPasswordFieldValidationTest() {
		...
		try {
			...
			FileUtils
					.copyFile(
							scrFile,
							new File(
									"c:\\tmp\\TC_AccountSettingsVerifyNewPasswordFieldValidationDev.png"));
