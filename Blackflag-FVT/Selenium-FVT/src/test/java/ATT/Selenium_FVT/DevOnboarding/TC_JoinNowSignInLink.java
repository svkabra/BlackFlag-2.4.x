...
public class TC_JoinNowSignInLink extends TestUtil{

	/* Test case to verify that the user gets error when trying to enter existing email id on join now page*/	
	...
	public void testEmailValidation() {
		...
		joinNow.signinFromErrorMsg();
		joinNow.validateSignin();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_JoinNowSignInLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
