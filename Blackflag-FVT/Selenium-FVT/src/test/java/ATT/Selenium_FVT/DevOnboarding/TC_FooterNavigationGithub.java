...
public class TC_FooterNavigationGithub extends TestUtil{
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FooterNavigationGithub.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
