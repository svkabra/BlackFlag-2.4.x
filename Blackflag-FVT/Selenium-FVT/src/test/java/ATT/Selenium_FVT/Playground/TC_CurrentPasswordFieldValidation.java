...
public class TC_CurrentPasswordFieldValidation extends TestUtil{

	@Test
	public void currentPasswordFieldValidation_test() {
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CurrentPasswordFieldValidation.png"));
