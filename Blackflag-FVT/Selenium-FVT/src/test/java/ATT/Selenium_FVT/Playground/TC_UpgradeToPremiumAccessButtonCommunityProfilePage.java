...
public class TC_UpgradeToPremiumAccessButtonCommunityProfilePage extends TestUtil{
	...
	public void upgradeToPremiumAccessButtonCommunityProfilePage_test() {
		...
		communityProfilePage.upgradeToPremiumAccessButtonValidation();
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_UpgradeToPremiumAccessButtonCommunityProfilePage.png"));
