...
public class TC_ManageLegalAgreementLinkValidation extends TestUtil {
	...
	public void manageLegalAgreementValidation_test() {
		...
		ManageLegalAgreementPage manageLegalAgreemetsPage = manageMyAcct.clickManageLegalAgreements();
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ManageLegalAgreementLinkValidation.png"));
