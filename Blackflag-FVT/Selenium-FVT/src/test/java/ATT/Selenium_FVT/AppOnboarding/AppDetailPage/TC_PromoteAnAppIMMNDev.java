...
public class TC_PromoteAnAppIMMNDev extends TestUtil{

/*	Verify that Developer is able to promote App containing  IMMN API to production */
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppIMMNDev.png"));
		} catch (IOException e) {
