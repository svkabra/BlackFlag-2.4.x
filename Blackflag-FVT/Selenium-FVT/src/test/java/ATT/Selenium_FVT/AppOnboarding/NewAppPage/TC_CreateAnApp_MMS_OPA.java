...
public class TC_CreateAnApp_MMS_OPA extends TestUtil{

	/* Test case to verify that OPA is able to create an application with the Multimedia Messaging Service (MMS) API included in scope */
