...
public class TC_PromoteAnAppSMSDev extends TestUtil{

/*	Verify that Developer is able to promote App containing  SMS to production */
	...
	public void testAppPromotion() {
		...
		newApp.selectAPI(Constants.SMS);
