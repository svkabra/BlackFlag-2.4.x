...
public class TC_CreateAnApp_TTS_OPA extends TestUtil{

	/* Test case to verify that OPA is able to create an application with the Text to Speech (TTS) API included in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_TTS_OPA.png"));
		} catch (IOException e) {
