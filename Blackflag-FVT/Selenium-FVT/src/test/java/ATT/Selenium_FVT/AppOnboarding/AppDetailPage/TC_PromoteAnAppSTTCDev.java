...
public class TC_PromoteAnAppSTTCDev extends TestUtil{

	/*	Verify that Developer is able to promote App containing  STTC API to production*/
	...
	public void testAppPromotion() {
		...
		newApp.selectAPI(Constants.SPEECH_TO_TEXT_CUSTOM);
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppSTTCDev.png"));
		} catch (IOException e) {
