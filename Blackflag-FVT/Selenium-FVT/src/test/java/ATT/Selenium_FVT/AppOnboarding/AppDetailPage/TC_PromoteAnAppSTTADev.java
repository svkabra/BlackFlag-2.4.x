...
public class TC_PromoteAnAppSTTADev extends TestUtil{

/*	Verify that Developer is able to promote App with  SpeechToTextAsync API to production*/
	...
	public void testAppPromotion() {
		...
		newApp.selectAPI(Constants.SPEECH_TO_TEXT_ASYNC);
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppSTTADev.png"));
		} catch (IOException e) {
