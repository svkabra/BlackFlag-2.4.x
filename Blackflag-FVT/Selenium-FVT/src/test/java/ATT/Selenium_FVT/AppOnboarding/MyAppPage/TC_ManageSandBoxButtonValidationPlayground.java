...
public class TC_ManageSandBoxButtonValidationPlayground extends TestUtil{

	/**   Verify that Playground can view sandbox app detail page by clicking on Manage Sandbox button 
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ManageSandBoxButtonValidationPlayground.png"));
		} catch (IOException e) {
