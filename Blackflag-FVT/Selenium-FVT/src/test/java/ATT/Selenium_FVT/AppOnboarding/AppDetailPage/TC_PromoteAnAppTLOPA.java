...
public class TC_PromoteAnAppTLOPA extends TestUtil{

	/*	Verify that OPA is able to promote App containing  TL API to production*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppTLOPA.png"));
		} catch (IOException e) {
