...
public class TC_CreateAnApp_Speech_IVEE_Dev extends TestUtil{

	/* Test case to verify that Dev should be able to create an app with Speech To Text Custom IVEE API in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_Speech_IVEE_Dev.png"));
		} catch (IOException e) {
