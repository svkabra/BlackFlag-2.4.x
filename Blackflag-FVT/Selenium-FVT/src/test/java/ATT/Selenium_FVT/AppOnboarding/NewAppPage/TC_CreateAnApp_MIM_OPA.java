...
public class TC_CreateAnApp_MIM_OPA extends TestUtil{

	/* Test case to verify that OPA is able to create an application with the In App Messaging - MIM API included in scope*/
