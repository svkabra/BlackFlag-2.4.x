...
public class TC_CreateAnApp_DC_Dev extends TestUtil{

	/* Test case to verify that Dev is able to create an application with the Device Capabilities API included in scope*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_DC_Dev.png"));
		} catch (IOException e) {
