...
public class TC_CreateAnApp_TTS_Playground extends TestUtil{

	/* Test case to verify that Playground User is able to create an application with the Text to Speech (TTS) API included in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_TTS_Playground.png"));
		} catch (IOException e) {
