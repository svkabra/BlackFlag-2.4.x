...
public class TC_CreateAnApp_Adv_Playground extends TestUtil{

	/* Test case to verify that  Playground User is able to create an application with the Advertising API included in scope */	
