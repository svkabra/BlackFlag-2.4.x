...
public class TC_PromoteAnAppMMSOPA extends TestUtil{

	/*	Verify that OPA is able to promote App containing  MMS to production */
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppMMSOPA.png"));
		} catch (IOException e) {
