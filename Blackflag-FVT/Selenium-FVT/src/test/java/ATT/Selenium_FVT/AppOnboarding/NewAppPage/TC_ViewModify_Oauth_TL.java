...
public class TC_ViewModify_Oauth_TL extends TestUtil{

	/* Verify that Dev is able to view OAuth Redirect URL when Terminal Location is selected on the new app page */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ViewModify_Oauth_TL.png"));
		} catch (IOException e) {
