...
public class TC_EditAppAddNewApiTL extends TestUtil{

	/* Verify that user can  Add TL api to existing  sandbox Application */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\EditApp_AddNewApi_TL.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
