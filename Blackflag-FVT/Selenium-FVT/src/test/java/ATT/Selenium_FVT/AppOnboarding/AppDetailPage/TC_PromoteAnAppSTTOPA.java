...
public class TC_PromoteAnAppSTTOPA extends TestUtil{

/*	Verify that OPA is able to promote App containing  STT to production*/
	...
	public void testAppPromotion() {
		...
		newApp.selectAPI(Constants.SPEECH_TO_TEXT);
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppSTTOPA.png"));
		} catch (IOException e) {
