...
public class TC_PromoteAnAppTLDev extends TestUtil{

	/*	Verify that Developer is able to promote App containing  TL API to production*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppTLDev.png"));
		} catch (IOException e) {
