...
public class TC_EditAppAddNewApiSMS extends TestUtil{

	/* Verify that user can  Add SMS api to existing  sandbox Application */	
	...
	public void testEditApp() {
		...
		// Validate if SMS API is added to scope  		
		appPage.valaidateIsApiEdited("SMS");
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\EditApp_AddNewApi_SMS.png"));
		} catch (IOException e) {
