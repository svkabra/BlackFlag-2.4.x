...
public class TC_ViewModify_Oauth_STTC extends TestUtil{

	/* Verify that Dev is not able to view OAuth Redirect URL when Speech To Text Custom (STTC)  is selected on the new app page */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ViewModify_Oauth_STTC.png"));
		} catch (IOException e) {
