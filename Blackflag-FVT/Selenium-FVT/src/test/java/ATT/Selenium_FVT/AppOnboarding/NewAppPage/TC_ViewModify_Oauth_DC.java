...
public class TC_ViewModify_Oauth_DC extends TestUtil{

	/* Verify that Dev is able to view OAuth Redirect URL when Device Capability is selected on the new app page */	
