...
public class TC_ViewModifyOauthSTTCViaEditApp extends TestUtil{

	/* Verify that Developer is able to view OAuth Redirect URL when STTC  is selected on the Edit App Page */	
	...
	public void testAppCreation() {
		...
		editAppPage.selectAPI(Constants.STTC);
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\ViewModify_Oauth_STTC_ViaEditApp.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
