...
public class TC_PromoteAnAppSTTAOPA extends TestUtil{

/*	Verify that OPA is able to promote App with  SpeechToTextAsync API to production*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppSTTAOPA.png"));
		} catch (IOException e) {
