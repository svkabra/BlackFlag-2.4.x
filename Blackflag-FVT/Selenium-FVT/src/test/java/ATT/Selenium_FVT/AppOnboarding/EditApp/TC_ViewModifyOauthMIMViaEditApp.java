...
public class TC_ViewModifyOauthMIMViaEditApp extends TestUtil {
	...
	/*
	 * Verify that Developer is able to view OAuth Redirect URL when MIM is
	...
	public void testAppCreation() {
		...
		// Validate if Developer is able to view OAuth Redirect URL when MIM is
		// selected on the Edit App Page
	...
	public void takeScreenShot() {
		...
		try {
			FileUtils.copyFile(scrFile, new File(
					"c:\\tmp\\ViewModify_Oauth_MIM_ViaEditApp.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
