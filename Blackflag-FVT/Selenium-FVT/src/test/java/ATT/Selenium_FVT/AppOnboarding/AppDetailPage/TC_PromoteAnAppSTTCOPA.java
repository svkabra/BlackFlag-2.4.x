...
public class TC_PromoteAnAppSTTCOPA extends TestUtil{

	/*	Verify that OPA is able to promote App containing  STTC API to production*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppSTTCOPA.png"));
		} catch (IOException e) {
