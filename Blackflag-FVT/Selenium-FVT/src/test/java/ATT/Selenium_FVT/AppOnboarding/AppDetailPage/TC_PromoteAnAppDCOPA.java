...
public class TC_PromoteAnAppDCOPA extends TestUtil {

	/* Verify that OPA is able to promote App containing DC API to production */
	...
	public void testAppPromotion() {
		...
		RequestProductionAccessPage req = appPage
				.clickRequestProductionAccess();
