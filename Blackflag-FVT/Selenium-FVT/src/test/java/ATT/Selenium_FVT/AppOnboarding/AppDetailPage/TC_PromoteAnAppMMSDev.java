...
public class TC_PromoteAnAppMMSDev extends TestUtil{

/*	Verify that Developer is able to promote App containing  MMS to production */
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppMMSDev.png"));
		} catch (IOException e) {
