...
public class TC_CancelAppCreationPlayground extends TestUtil{

	/* Verify that Playground  can cancel App creation process after filling all details */	
	...
	public void testCanceAppCreation() {
		...
		newAppPage.clickOrCancel();
		newAppPage.validateOrCancel(appname);
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CancelAppCreationPlayground.png"));
		} catch (IOException e) {
