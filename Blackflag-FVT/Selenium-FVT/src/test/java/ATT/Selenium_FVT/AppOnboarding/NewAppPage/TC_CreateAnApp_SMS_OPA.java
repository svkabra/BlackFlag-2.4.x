...
public class TC_CreateAnApp_SMS_OPA extends TestUtil{

	/* Test case to verify that OPA is able to create an application with the Short Messaging Service (SMS) API included in scope */	
	...
	public void testAppCreation() {
		...
		// Method to validate if SMS API is added to scope  		
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_SMS_OPA.png"));
		} catch (IOException e) {
