...
public class TC_CreateAnApp_MIM_Dev extends TestUtil{

	/* Test case to verify that Dev is able to create an application with the In App Messaging - MIM API included in scope*/	
	...
	public void testAppCreation() {
		...
		// Method to validate if MIM API is added to scope  		
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_MIM_Dev.png"));
		} catch (IOException e) {
