...
public class TC_CreateAnApp_Speech_STT_Dev extends TestUtil{

	/* Test case to verify that Dev is able to create an application with the SpeechToText (Speech) API included in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_Speech_STT_Dev.png"));
		} catch (IOException e) {
