...
public class TC_ViewModifyOauthMMSViaEditApp extends TestUtil{

	/* Verify that Developer is able to view OAuth Redirect URL when MMS  is selected on the Edit App Page */	
	...
	public void testAppCreation() {
		...
		editAppPage.selectAPI("MMS");
		
		
		//Validate if Developer is able to view OAuth Redirect URL when MMS  is selected on the Edit App Page  
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\ViewModify_Oauth_MMS_ViaEditApp.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
