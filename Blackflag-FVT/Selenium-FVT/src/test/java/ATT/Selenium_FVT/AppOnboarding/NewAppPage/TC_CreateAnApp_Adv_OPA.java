...
public class TC_CreateAnApp_Adv_OPA extends TestUtil{

	/* Test case to verify that  OPA is able to create an application with the Advertising API included in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_Adv_OPA.png"));
		} catch (IOException e) {
