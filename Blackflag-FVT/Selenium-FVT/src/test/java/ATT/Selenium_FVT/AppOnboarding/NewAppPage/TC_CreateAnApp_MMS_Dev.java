...
public class TC_CreateAnApp_MMS_Dev extends TestUtil{

	/* Test case to verify that Dev is able to create an application with the Multimedia Messaging Service (MMS) API included in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_MMS_Dev.png"));
		} catch (IOException e) {
