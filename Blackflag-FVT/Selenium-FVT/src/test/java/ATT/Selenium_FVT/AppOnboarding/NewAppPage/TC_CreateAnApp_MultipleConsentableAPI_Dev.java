...
public class TC_CreateAnApp_MultipleConsentableAPI_Dev extends TestUtil{
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_MultipleConsentableAPI_Dev.png"));
		} catch (IOException e) {
