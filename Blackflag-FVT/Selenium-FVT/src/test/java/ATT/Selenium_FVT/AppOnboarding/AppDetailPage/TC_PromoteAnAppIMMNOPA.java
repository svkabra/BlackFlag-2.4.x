...
public class TC_PromoteAnAppIMMNOPA extends TestUtil{

	/*	Verify that OPA is able to promote App containing  IMMN API to production */
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PromoteAnAppIMMNOPA.png"));
		} catch (IOException e) {
