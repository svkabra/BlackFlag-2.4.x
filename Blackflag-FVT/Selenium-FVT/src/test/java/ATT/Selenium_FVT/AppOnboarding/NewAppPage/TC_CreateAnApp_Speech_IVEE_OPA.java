...
public class TC_CreateAnApp_Speech_IVEE_OPA extends TestUtil{

	/* Test case to verify that OPA should be able to create an app with Speech To Text Custom IVEE API in scope */	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CreateAnApp_Speech_IVEE_OPA.png"));
		} catch (IOException e) {
