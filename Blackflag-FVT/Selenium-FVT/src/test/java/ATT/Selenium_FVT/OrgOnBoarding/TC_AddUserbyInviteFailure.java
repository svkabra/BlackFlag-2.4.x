...
public class TC_AddUserbyInviteFailure extends TestUtil{

	@Test
	public void addUserbyInvite_test() {
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_AddUserbyInviteFailure.png"));
