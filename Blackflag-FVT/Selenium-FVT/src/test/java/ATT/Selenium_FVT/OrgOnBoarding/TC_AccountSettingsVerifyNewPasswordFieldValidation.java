...
public class TC_AccountSettingsVerifyNewPasswordFieldValidation extends TestUtil {

	@Test
	public void accountSettingsVerifyNewPasswordFieldValidation_test() {
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\ TC_AccountSettingsVerifyNewPasswordFieldValidation.png"));
