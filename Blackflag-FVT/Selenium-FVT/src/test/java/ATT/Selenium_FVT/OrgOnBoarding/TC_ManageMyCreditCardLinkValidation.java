...
public class TC_ManageMyCreditCardLinkValidation extends TestUtil {

	@Test
	public void manageMyCreditCardLinkValidation_test() {
	...
	public void takeScreenShot() {
		...
		try {
			...
			FileUtils.copyFile(scrFile, new File(
					"c:\\tmp\\TC_ManageMyCreditCardLinkValidation.png"));
