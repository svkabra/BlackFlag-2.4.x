...
public class TC_Dev_Export_CSV_My_Apps extends TestUtil{
...
//Step 6 -- Check if the file has been exported successfully
			...
			filePathString = "C:\\Temp\\export.csv";	
			myapps.fnExportcsv(filePathString);
			...
			if(x){							
				...
				file.fnCheckFileExists(sNewFilePath);
