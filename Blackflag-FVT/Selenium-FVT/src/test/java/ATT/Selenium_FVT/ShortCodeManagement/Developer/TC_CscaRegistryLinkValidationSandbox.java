...
public class TC_CscaRegistryLinkValidationSandbox extends TestUtil {

	public boolean flag=false;
	@Test
	public void cscaRegistryLinkValidationSandbox_test() {
		...
		//AppPage appPage = myAppPageObj.clickTestAppSandbox();
		...
		mngShortCode.selectShortCodeType("custom");
		
		
		//method to click on CSCA registry link
		mngShortCode.clickCSCA_Link();
		
		//method to validate the CSCA link opened
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_CscaRegistryLinkValidationSandbox.png"));
		} catch (IOException e) {
