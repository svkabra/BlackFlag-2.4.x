...
public class TC_DefaultSmsShortCodeSandbox extends TestUtil {
	...
	public void defaultSmsShortCodeSandbox_test() {
		...
		//AppPage appPage = myAppPage.clickTestSmsAppSandbox();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_DefaultSmsShortCodeSandbox.png"));
		} catch (IOException e) {
