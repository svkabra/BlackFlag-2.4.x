...
public class TC_DefaultSmsMmsShortCodeProduction extends TestUtil {

	public boolean flag=false;
	@Test
	public void defaultSmsShortCodeSandbox_test() {
		...
		//AppPage appPage = myAppPage.clickTestSmsAppProduction();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_DefaultSmsMmsShortCodeProduction.png"));
		} catch (IOException e) {
