...
public class TC_MoUriFieldsOptionalProduction extends TestUtil {

	public boolean flag=false;
	
	@Test
	public void moUriFieldsOptionalProduction_test() {
	...
	public void takeScreenShot() {
		...
		try {
			FileUtils.copyFile(scrFile, new File(
					"c:\\tmp\\TC_DescriptionFieldOptionalProduction.png"));
		} catch (IOException e) {
