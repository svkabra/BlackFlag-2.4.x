...
public class TC_DefaultMmsShortCodeSandbox extends TestUtil {

	public boolean flag=false;
	
	@Test
	public void defaultMmsShortCodeSandbox_test() {
		...
		//AppPage appPage = myAppPage.clickTestMmsAppSandbox();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_DefaultMmsShortCodeSandbox.png"));
		} catch (IOException e) {
