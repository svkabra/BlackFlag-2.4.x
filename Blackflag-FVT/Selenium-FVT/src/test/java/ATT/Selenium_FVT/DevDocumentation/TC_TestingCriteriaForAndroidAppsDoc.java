...
public class TC_TestingCriteriaForAndroidAppsDoc extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Testing Criteria for Android Applications*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		footersDocs.clickTestingCriForAndroidApps();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_TestingCriteriaForAndroidAppsDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
