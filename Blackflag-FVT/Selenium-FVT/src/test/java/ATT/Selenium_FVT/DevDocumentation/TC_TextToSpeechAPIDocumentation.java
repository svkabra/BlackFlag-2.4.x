...
public class TC_TextToSpeechAPIDocumentation extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Text To Speech API on App details page*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_TextToSpeechAPIDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
