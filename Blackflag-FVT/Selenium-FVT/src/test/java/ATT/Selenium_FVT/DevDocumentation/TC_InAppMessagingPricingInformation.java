...
public class TC_InAppMessagingPricingInformation extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing Information for In-App Messaging*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_InAppMessagingPricingInformation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
