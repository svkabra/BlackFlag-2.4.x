...
public class TC_AdvertisingSDKForAndroidView extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for Advertising SDK for Android*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		footersDocs.clickAdvertisingSDKForAndroidView();	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_AdvertisingSDKForAndroidView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
