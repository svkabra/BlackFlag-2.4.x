...
public class TC_DeviceAnywhereVirtualDeveloperLabView extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for DeviceAnywhere Virtual Developer Lab*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_DeviceAnywhereVirtualDeveloperLabView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
