...
public class TC_ATTAPISDKsForWindowsView extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for  AT&T API SDKs for Windows®*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTAPISDKsForWindowsView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
