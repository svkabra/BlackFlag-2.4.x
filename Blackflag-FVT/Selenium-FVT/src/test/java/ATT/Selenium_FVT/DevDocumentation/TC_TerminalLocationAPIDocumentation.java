...
public class TC_TerminalLocationAPIDocumentation extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Terminal Location API on App details page*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_TerminalLocationAPIDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
