...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Other ATT Websites*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_OtherATTWebsitesLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
