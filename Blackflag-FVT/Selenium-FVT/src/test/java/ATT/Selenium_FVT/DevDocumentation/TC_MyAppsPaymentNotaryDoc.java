...
public class TC_MyAppsPaymentNotaryDoc extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Notary Documentation icon on Payment API Doc*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickPaymentAPIDocNotaryDoc();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsPaymentNotaryDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
