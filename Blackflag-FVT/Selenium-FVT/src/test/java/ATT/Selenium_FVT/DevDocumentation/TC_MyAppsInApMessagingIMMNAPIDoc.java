...
public class TC_MyAppsInApMessagingIMMNAPIDoc extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against In app Messaging IMMN API on My Apps page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickInAppMessagingIMMNAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsInApMessagingIMMNAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
