...
public class TC_NetworkTechnologiesLink extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Network Technologies*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		technicalLibraryPage.clickNetworkTechnologiesLink();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_NetworkTechnologiesLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
