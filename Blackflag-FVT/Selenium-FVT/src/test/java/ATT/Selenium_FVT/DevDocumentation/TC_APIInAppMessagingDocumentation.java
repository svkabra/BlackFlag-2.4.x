...
public class TC_APIInAppMessagingDocumentation extends TestUtil {

/* Test case to verify that the Dev portal Page routes to correct link when clicked on Documentation button for In-App Messaging*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_APIInAppMessagingDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
