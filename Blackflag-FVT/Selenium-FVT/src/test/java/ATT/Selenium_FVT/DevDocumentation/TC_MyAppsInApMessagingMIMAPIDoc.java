...
public class TC_MyAppsInApMessagingMIMAPIDoc extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against In App Messaging MIM API on My Apps page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickInAppMessagingMIMAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsInApMessagingMIMAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
