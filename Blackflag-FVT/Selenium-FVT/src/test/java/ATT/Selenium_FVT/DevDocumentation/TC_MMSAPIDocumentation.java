...
public class TC_MMSAPIDocumentation extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against MMS API on App details page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickMMSAPIDocumentation();			
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MMSAPIDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
