...
public class TC_MyAppsSeechToTextCustomAPIDoc  extends TestUtil{
...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Speech To Text Custom API on App details page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickSpeechToTextCustomAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsSeechToTextCustomAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
