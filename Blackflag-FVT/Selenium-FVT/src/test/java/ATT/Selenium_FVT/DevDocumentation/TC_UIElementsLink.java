...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under UI Elements*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_UIElementsLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
