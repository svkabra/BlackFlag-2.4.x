...
public class TC_ATTAPIAdaptersForIBMWorklightView extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for AT&T API Adapters for IBM® Worklight®*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTAPIAdaptersForIBMWorklightView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
