...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing Information for AT&T Sponsored Data*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTSponsoredDataPricingInformation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
