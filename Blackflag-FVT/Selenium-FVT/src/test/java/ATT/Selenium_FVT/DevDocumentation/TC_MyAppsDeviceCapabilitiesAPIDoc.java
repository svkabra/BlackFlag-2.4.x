...
public class TC_MyAppsDeviceCapabilitiesAPIDoc extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Device Capabilities API on My Apps page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickDeviceCapabilitiesAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsDeviceCapabilitiesAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
