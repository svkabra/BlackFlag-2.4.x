...
public class TC_SpeechPricingInformation extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing Information for Speech*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_SpeechPricingInformation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
