...
/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under External Access Gateway*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		technicalLibraryPage.clkExternalAccessGatewayLink();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ExternalAccessGatewayLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
