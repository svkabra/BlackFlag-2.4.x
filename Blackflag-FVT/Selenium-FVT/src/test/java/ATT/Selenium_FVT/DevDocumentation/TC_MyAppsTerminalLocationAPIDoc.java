...
public class TC_MyAppsTerminalLocationAPIDoc extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Terminal Location API on My Apps page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickTerminalLocationAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsTerminalLocationAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
