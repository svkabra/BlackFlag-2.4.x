...
public class TC_ATTToolkitForSalesforcePlatformView extends TestUtil {


/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for AT&T Toolkit for Salesforce® Platform*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		footersDocs.clickATTToolkitForSalesforcePlatformView();	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTToolkitForSalesforcePlatformView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
