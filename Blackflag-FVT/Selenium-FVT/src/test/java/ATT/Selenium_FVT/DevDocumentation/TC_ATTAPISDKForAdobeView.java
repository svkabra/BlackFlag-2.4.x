...
public class TC_ATTAPISDKForAdobeView extends TestUtil {

/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for AT&T API SDK  for Adobe® PhoneGap®*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTAPISDKForAdobeView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
