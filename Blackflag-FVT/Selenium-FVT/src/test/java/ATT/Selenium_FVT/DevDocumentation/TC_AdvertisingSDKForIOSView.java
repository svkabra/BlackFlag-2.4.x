...
public class TC_AdvertisingSDKForIOSView extends TestUtil {

/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for Advertising SDK for iOS*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_AdvertisingSDKForIOSView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
