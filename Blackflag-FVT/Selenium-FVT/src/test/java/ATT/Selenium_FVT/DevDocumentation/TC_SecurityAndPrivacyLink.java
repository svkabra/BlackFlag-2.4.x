...
public class TC_SecurityAndPrivacyLink extends TestUtil{

/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Security & Privacy*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		technicalLibraryPage.clickSecurityAndPrivacyLink();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_SecurityAndPrivacyLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
