...
public class TC_SpeechToTextAPIDocumentation extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Speech To Text API on App details page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickSpeechToTextAPIDocumentation();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_SeechToTextAPIDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
