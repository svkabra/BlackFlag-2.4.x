...
public class TC_SpeechSDKForAndroidView extends TestUtil {

/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for Speech SDK for Android*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		footersDocs.clickSpeechSDKForAndroidView();	
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_SpeechSDKForAndroidView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
