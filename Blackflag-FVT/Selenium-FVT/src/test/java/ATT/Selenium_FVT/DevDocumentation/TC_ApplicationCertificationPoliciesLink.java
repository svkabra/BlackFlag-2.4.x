...
public class TC_ApplicationCertificationPoliciesLink extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Application Certification Policies*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		technicalLibraryPage.clickApplicationCertificationPoliciesLink();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ApplicationCertificationPoliciesLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
