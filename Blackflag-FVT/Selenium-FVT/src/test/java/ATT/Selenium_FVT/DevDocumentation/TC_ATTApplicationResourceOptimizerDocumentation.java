...
public class TC_ATTApplicationResourceOptimizerDocumentation extends TestUtil {

/* Test case to verify that the Dev portal Page routes to correct link when clicked on Documentation button for AT&T Application Resource Optimizer*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTApplicationResourceOptimizerDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
