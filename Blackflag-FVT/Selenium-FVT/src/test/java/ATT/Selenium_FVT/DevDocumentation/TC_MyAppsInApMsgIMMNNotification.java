...
public class TC_MyAppsInApMsgIMMNNotification extends TestUtil{


/* Test case to verify that the Dev portal Page routes to correct link when clicked on Notification icon on In app Messaging IMMN API*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickInAppMessagingIMMNAPIDocNotification();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsInApMsgIMMNNotification.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
