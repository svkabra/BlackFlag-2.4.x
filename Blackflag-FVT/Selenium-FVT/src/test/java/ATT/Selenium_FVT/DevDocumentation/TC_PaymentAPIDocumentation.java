...
public class TC_PaymentAPIDocumentation extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Payment API on App details page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickPaymentAPIDocumentation();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PaymentAPIDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
