...
public class TC_MyAppsMMSAPIDoc extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against MMS API on My Apps page*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsMMSAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
