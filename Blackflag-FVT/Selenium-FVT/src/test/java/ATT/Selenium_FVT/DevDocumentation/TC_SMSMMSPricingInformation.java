...
public class TC_SMSMMSPricingInformation extends TestUtil {



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing Information for SMS/MMS*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_SMSMMSPricingInformation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
