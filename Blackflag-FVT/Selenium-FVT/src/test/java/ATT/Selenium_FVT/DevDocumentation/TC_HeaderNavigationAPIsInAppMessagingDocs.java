...
public class TC_HeaderNavigationAPIsInAppMessagingDocs extends TestUtil {


/* Test case to verify that the Dev portal Page routes to correct link when clicked on In-App Messaging Docs*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HeaderNavigationAPIsSpeechDocs.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
