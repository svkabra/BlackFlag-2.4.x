...
public class TC_ATTAPIModuleForAppceleratorTitaniumView extends TestUtil {
 
/* Test case to verify that the Dev portal Page routes to correct link when clicked on View Button for AT&T API Module for Appcelerator® Titanium®*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ATTAPIModuleForAppceleratorTitaniumView.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
