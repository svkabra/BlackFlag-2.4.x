...
public class TC_DeviceTechnologiesLink extends TestUtil {


/* Test case to verify that the Dev portal Page routes to correct link when clicked on links under Device Technologies*/
	...
	public void testHeaderNavigation() {
		...
		headers.clickLogo();
		technicalLibraryPage.clickDeviceTechnologiesLink();
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_DeviceTechnologiesLink.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
