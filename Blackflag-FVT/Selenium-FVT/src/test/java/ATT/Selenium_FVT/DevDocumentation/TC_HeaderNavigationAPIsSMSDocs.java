...
public class TC_HeaderNavigationAPIsSMSDocs extends TestUtil {


/* Test case to verify that the Dev portal Page routes to correct link when clicked on SMS Docs*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_HeaderNavigationAPIsSMSDocs.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
