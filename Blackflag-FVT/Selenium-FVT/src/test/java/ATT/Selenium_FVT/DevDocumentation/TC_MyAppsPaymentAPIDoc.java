...
public class TC_MyAppsPaymentAPIDoc extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Document icon against Payment API on My Apps page*/
	...
	public void testHeaderNavigation() {
		...
		appDetailsPage.clickPaymentAPIDocumentationMyApps();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_MyAppsPaymentAPIDoc.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
