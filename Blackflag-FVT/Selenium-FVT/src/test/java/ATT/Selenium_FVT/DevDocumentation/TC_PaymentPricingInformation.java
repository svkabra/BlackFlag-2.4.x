...
public class TC_PaymentPricingInformation extends TestUtil{



/* Test case to verify that the Dev portal Page routes to correct link when clicked on Pricing Information for Payment*/
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_PaymentPricingInformation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
