...
public class TC_FAQsDocumentation extends TestUtil {


/* Test case to verify that the Dev portal Page routes to correct link when clicked on 'FAQs' from the left navigation pane of Documentation*/
	...
	public void testHeaderNavigation() {
		...
		apiDocumentationPage.clickFAQs();				
	}
    ...
    public void takeScreenShot() {
        ...
        try {
			FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_FAQsDocumentation.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
