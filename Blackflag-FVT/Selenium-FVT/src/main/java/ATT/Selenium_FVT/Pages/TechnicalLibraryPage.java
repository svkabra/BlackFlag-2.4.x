...
public class TechnicalLibraryPage extends WebPage {
	...
	// Page Object
	// "Can Prosidy Inform Sentiment Analysis? Experiments on Short Spoken Reviews"
	...
	public TechnicalLibraryPage clickTechnicalLibraryLink() {
	...
	/* Method to click on links under Access Point Names */
	public TechnicalLibraryPage clickAccessPointNamesLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickApplicationCertificationPoliciesLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickDeviceTechnologiesLink() {
		clickTechnicalLibraryLink();
		biometrics.click();
		waitForPageToLoad();
	...
	public TechnicalLibraryPage clickExternalAccessGatewayLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickNetworkTechnologiesLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickSecurityAndPrivacyLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickOtherATTWebsitesLink() {
	...
	public TechnicalLibraryPage clickUIElementsLink() {
		clickTechnicalLibraryLink();
	...
	public TechnicalLibraryPage clickWhitePapersLink() {
